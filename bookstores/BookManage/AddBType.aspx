<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMasterPage.master" AutoEventWireup="true" CodeFile="AddBType.aspx.cs" Inherits="BookManage_AddBType" Title="Untitled Page" EnableEventValidation="false"%>
...
<table width="771" height="465" border="0" align="center" cellpadding="0" cellspacing="1" class="waikuang">
        <tr>
          ...
          <td valign="top"><table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="45" colspan="3" background="../images/tianjiaxiugaitushuxinxi.gif" style="background-image: url(../images/tianjiatushuleixingxinxi.gif)">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="3" background="../images/tu shu pai hang2.gif"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td colspan="3"><label>
                    <asp:TextBox ID="txtBType" runat="server"></asp:TextBox>
                  </label></td>
                  <td width="306" align="center">&nbsp;</td>
                </tr>
                <tr>
                  <td height="28" align="right" class="daohang1">&nbsp;</td>
                  <td height="28" align="center" class="daohang1">可借天数：</td>
                  <td colspan="3"><asp:TextBox ID="txtDay" runat="server" Width="149px"></asp:TextBox></td>
                  <td align="center">&nbsp;</td>
                </tr>
                <tr>
