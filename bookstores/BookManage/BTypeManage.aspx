            ...
            <tr>
              <td height="22" background="../images/tu shu pai hang2.gif"><table width="756" height="77" border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="89" align="right" class="daohang1"><asp:HyperLink ID="hpLinkAddBType" runat="server" NavigateUrl="~/BookManage/AddBType.aspx" Width="98px" ForeColor="Black">添加图书类型信息</asp:HyperLink></td>
                  <td width="45">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
