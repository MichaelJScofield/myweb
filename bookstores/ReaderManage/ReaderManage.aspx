<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMasterPage.master" AutoEventWireup="true"
    CodeFile="ReaderManage.aspx.cs" Inherits="ReaderManage_ReaderManage" Title="Untitled Page"
                ...
                <table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="22" background="../images/tu shu pai hang2.gif">
                            <table width="756" height="77" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="3" align="right" background="../images/danganguanli.gif" style="height: 44px;
                                        background-image: url(../images/duzhedanganguanli.gif);">
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td width="622" height="32" align="right">
                                        <img src="../images/tianjia tubiao.gif" width="19" height="18"></td>
                                    <td width="89" align="right" class="daohang1">
                                        <asp:HyperLink ID="hpLinkAddReader" runat="server" NavigateUrl="~/ReaderManage/AddReader.aspx"
                                            ForeColor="Black">添加读者信息</asp:HyperLink></td>
                                    <td width="45">
                                        &nbsp;</td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td height="23" background="../images/tu shu pai hang2.gif">
                            <asp:GridView ID="gvReaderInfo" runat="server" AllowPaging="True" CellPadding="4"
                                ForeColor="#333333" PageSize="5" AutoGenerateColumns="False" Font-Size="9pt"
                                OnPageIndexChanging="gvReaderInfo_PageIndexChanging" OnRowDeleting="gvReaderInfo_RowDeleting"
